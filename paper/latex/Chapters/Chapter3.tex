...
% 	\begin{tabular}{|l|l|}
% 		\hline
% 		\rule{0pt}{3ex}\textbf{Hyperparameter} & \textbf{Description}\\
% 		\hline
% 		\multicolumn{2}{|c|}{\rule{0pt}{2.6ex}\textit{Logistic Regression}} \\
% 		\hline
% 		C & Inverse of regularization strength \\
% 		penalty & Type of regularization \\
% 		solver & Optimization algorithm \\
% 		max\_iter & Maximum iterations for solvers \\
% 		\hline
% 		\multicolumn{2}{|c|}{\rule{0pt}{2.6ex}\textit{k-Nearest Neighbours}} \\
% 		\hline
...
% 		\hline
% 		\multicolumn{2}{|c|}{\rule{0pt}{2.6ex}\textit{Random Forest}} \\
% 		\hline
% 		n\_estimators & Number of trees in the forest  \\
% 		max\_depth & Maximum depth of the tree  \\
% 		min\_samples\_split & Min samples to split a node  \\
% 		min\_samples\_leaf & Min samples to be at a leaf node  \\
% 		max\_features & Number of features for best split  \\
% 		\hline
% 		\multicolumn{2}{|c|}{\rule{0pt}{2.6ex}\textit{Support Vector Classifier}} \\
% 		\hline
...
% 		\hline
% 		\multicolumn{2}{|c|}{\rule{0pt}{2.6ex}\textit{Gaussian Naive Bayes}} \\
% 		\hline
% 		var\_smoothing & Variance smoothing  \\
% 		\hline
% 		\multicolumn{2}{|c|}{\rule{0pt}{2.6ex}\textit{Multi-layer Perceptron}} \\
% 		\hline
% 		hidden\_layer\_sizes & Neurons in hidden layers \\
...
% 		\hline
% 		\multicolumn{2}{|c|}{\rule{0pt}{2.6ex}\textit{XGBoost}} \\
% 		\hline
...
% 		colsample\_bytree & Subsample ratio of columns for each tree \\
% 		gamma & Min loss reduction for partition on a leaf node \\
% 		\hline
% 	\end{tabular}
% 	\caption{Hyperparameters for various ML models}
...
\footnotetext[3]{Different hidden-layer topologies were tested including wide, narrow, symmetrical, bottleneck, and hierarchical}
...
The percentage of matches that were correctly classified is reported as the testing classification accuracy, labelled as \textbf{Test ACC}. 
